...
// TASK 2
//====lower case====
let personName, personName = "Babar";
...
console.log(`${author} once said,"${quote}`);
//Task 11
let members = ['sana', 'saba', 'ali', 'meerab', 'amna', 'azam'];
for (let i = 0; i < members.length; i++) {
    console.log(members[i]);
}
// TASK 12
let members = ['sana', 'saba', 'ali', 'meerab', 'amna', 'azam'];
let message = 'whats your name:';
for (let i = 0; i < members.length; i++) {
    console.log(message + members[i]);
}
//Task 13
let transportation = ['civi', 'bicycle', 'taxi', 'truck', 'van'];
for (let i = 0; i < transportation.length; i++) {
    console.log('I would like to own a ' + transportation[i]);
}
// //Task 14
let guest_list = ['ali', 'saad', 'rehab', 'wahaj'];
...
for (let i = 0; i < guest_list.length; i++) {
    ...
    //task 18
    let places = ['Cape town', 'Delhi', 'Faisalabad', 'Islamabad', 'Quetta'];
    ...
    //task 24
    let name_1 = "Amna";
    let name_2 = "Amna qureshi";
    let name_3 = " Miss Amna";
    if (name_1 == name_3) {
    ...
    let country = ["pakistan", "china", "india", "iran"];
    ...
    //task 29
    let favourite_fruits = ["kivi", "orange", "apple"];
    ...
    //task30
    let users = ["eric", "haseeb", "ali", "babar", "fahad"];
    ...
    //task 31
    let user = ["eric", "haseeb", "ali", "faraz", "babar"];
    if (user.length === 0) {
    ...
    // task 34
    let favourite_pizza = ["pepperoni", "veg", "chicken"];
...
const magicians2 = ["sana", "aliza", "basit"];
...
const magicians3 = ["usama", "haseeb", "wajahat"];
